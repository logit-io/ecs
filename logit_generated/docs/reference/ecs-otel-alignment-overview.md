...
The following table summarizes the alignment status by namespaces between ECS in version `9.0.0` and OpenTelemetry semantic conventions in version `1.36.0`.
...
| DNS | [18](/reference/ecs-dns.md) | [2](https://opentelemetry.io/docs/specs/semconv/attributes-registry/dns) | 1 | · | · | · | · | · | · |
...
| OTel | · | [8](https://opentelemetry.io/docs/specs/semconv/attributes-registry/otel) | · | · | · | · | · | · |  |
